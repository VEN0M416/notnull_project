...
export default function DropLink() {
  ...
  return (
    <div className="top-16 w-16 text-right bg-purple-700">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          ...
          <Menu.Items className="z-50 absolute right-0 mt-2 w-30 origin-top-right divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 border focus:outline-none">
